...
export default powerpoint("manage_slide_media", "Insert, replace, or delete editable PowerPoint image shapes on a slide.", {
  ...
  imageUrl: tool.schema.string().optional().describe("Source HTTPS image URL for insertImage or replaceImage."),
  imagePath: tool.schema.string().optional().describe("Local filesystem image path for insertImage or replaceImage."),
