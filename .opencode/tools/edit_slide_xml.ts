...
export default powerpoint("edit_slide_xml", "General-purpose single-slide XML editor. Exports one slide as a ZIP package, exposes ppt/slides/slide1.xml for DOM-based mutation, and reimports the edited slide in one round-trip. Use it for structural OOXML repairs that Office.js cannot express cleanly, including shape geometry and style fixes.", {
