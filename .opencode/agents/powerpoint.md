...
- Do not copy every property returned by `get_slide_shapes` into an update call. Omit unchanged fields, create-only fields, empty strings, placeholder text like `"Click to edit text"`, and filler zero values unless you explicitly want to set them
