...
export const officeToolDefinitions: Record<string, OfficeToolDefinition> = {
  ...
  get_document_headers_footers: tool("get_document_headers_footers", "Inspect Word header/footer configuration across sections.", { type: "object", properties: {} }, ["word"]),
  ...
  set_section_header_footer: tool("set_section_header_footer", "Configure Word headers or footers for one section or all sections.", { type: "object", properties: { target: { type: "string", enum: ["header", "footer"] }, type: { type: "string", enum: ["primary", "firstPage", "evenPages"] }, html: { type: "string" }, mode: { type: "string", enum: ["replace", "append"] }, sectionIndex: { type: "number" }, applyToAllSections: { type: "boolean" }, differentFirstPage: { type: "boolean" }, oddAndEvenPages: { type: "boolean" }, headerDistance: { type: "number" }, footerDistance: { type: "number" } }, required: ["target"] }, ["word"]),
  ...
  insert_table_of_contents: tool("insert_table_of_contents", "Insert a real Word table of contents at the current selection.", { type: "object", properties: { location: { type: "string", enum: ["replace", "before", "after", "start", "end"] }, upperHeadingLevel: { type: "number" }, lowerHeadingLevel: { type: "number" }, includePageNumbers: { type: "boolean" }, rightAlignPageNumbers: { type: "boolean" }, useHyperlinksOnWeb: { type: "boolean" } } }, ["word"]),
